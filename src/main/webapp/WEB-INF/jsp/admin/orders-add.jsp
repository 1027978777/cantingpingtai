...
<div class="x-body">
    <form class="layui-form" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input" disabled="true" id="time1" value="<fmt:formatDate value="${model.finishtime}" pattern="yyyy-MM-dd HH:mm:ss" />" name="finishtime"  placeholder="yyyy-MM-dd HH:mm:ss">
            </div>
        </div>
