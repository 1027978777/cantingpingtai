...
<body class="layui-anim layui-anim-up">
   ...
   <%--<xblock>--%>
        ...
        <%--&lt;%&ndash;<button class="layui-btn" onclick="x_admin_show('添加','/admin/ordersCai/add?no=${model.no}')"><i class="layui-icon"></i>添加</button>&ndash;%&gt;--%>
  <%----%>
      <%--</xblock>--%>
         ...
         <tr>
           ...
           <td class="td-manage">
                 ...
                 <button class="layui-btn layui-btn layui-btn-xs layui-bg-orange"
                        onclick="x_admin_show('编辑','/admin/ordersCai/edit2?id=${model.id}')"><i
