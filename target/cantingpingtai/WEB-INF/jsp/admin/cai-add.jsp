               ...
               <input name="image" value="${model.image}" type="hidden" lay-verify="required"/>
  	          ...
  	          <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        required="" lay-verify="required" value="${model.price}"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-input-block">
                    <input type="text" class="layui-input" id="time5" value="<fmt:formatDate value="${model.careatetime}" pattern="yyyy-MM-dd HH:mm:ss" />" name="careatetime"  placeholder="yyyy-MM-dd HH:mm:ss">
                </div>
            </div>
...
<script>
    layui.use(['form', 'layer'], function () {
        ...
        form.on('submit(add)', function (data) {
            console.log(data);
            //发异步，把数据提交给php
            $.post("/admin/cai/save", data.field, function (result) {
                if (result.code == 200) {
