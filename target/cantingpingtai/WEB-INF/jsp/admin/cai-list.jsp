...
<body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="/admin/cai/search" method="post">
   ...
   <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加','/admin/cai/add?bid=${model.bid}')"><i class="layui-icon"></i>添加</button>
      ...
      <table class="layui-table">
        ...
        <tbody>
         ...
         <tr>
            ...
            <td>
                <fmt:formatDate value="${model.careatetime}" pattern="yyyy-MM-dd HH:mm:ss"/> </td>
            </td>
           ...
           <td class="td-manage">
                 ...
                 <button class="layui-btn layui-btn layui-btn-xs layui-bg-orange"
                        onclick="x_admin_show('编辑','/admin/cai/edit?id=${model.id}')"><i
    ...
    <script>
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？删除后无法恢复',function(index){
              //发异步删除数据
              $.post("/admin/cai/delete",{id:id},function(result){
                  if (result.code == 200){
        ...
        layer.confirm('确认要删除吗？',function(index){
            ...
            for (i =0;i<ids.length; i++){
                 $.post("/admin/cai/delete",{id:ids[i]},function(result){
