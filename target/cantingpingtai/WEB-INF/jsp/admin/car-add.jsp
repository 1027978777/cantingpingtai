               ...
               <input name="image" value="${model.image}" type="hidden" lay-verify="required"/>
  	          ...
  	          <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        required="" lay-verify="required" value="${model.cprice}"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
  	          ...
  	          <div class="layui-form-item">
                    <label for="cnum" class="layui-form-label">
                        <span class="x-red">*</span>数量
                    </label>
                    <div class="layui-input-block">
                        <input type="number" id="cnum" name="cnum" 
                        required="" lay-verify="required" value="${model.cnum}"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
  	          ...
  	          <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        required="" lay-verify="required" value="${model.state}"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
...
<script>
    layui.use(['form', 'layer'], function () {
        ...
        form.on('submit(add)', function (data) {
            console.log(data);
            //发异步，把数据提交给php
            $.post("/admin/car/save", data.field, function (result) {
                if (result.code == 200) {
