...
<body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="/admin/evaluate/search" method="post">
   ...
   <xblock>
        ...
        <%--<button class="layui-btn" onclick="x_admin_show('添加','/admin/evaluate/add')"><i class="layui-icon"></i>添加</button>--%>
         ...
         <tr>
           ...
           <td class="td-manage">
                 ...
                 <%--<button class="layui-btn layui-btn layui-btn-xs layui-bg-orange"--%>
                        <%--onclick="x_admin_show('编辑','/admin/evaluate/edit?id=${model.id}')"><i--%>
    ...
    <script>
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？删除后无法恢复',function(index){
              //发异步删除数据
              $.post("/admin/evaluate/delete",{id:id},function(result){
                  if (result.code == 200){
        ...
        layer.confirm('确认要删除吗？',function(index){
            ...
            for (i =0;i<ids.length; i++){
                 $.post("/admin/evaluate/delete",{id:ids[i]},function(result){
